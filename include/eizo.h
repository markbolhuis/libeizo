...
enum eizo_usage : uint32_t {
    ...
    EIZO_USAGE_TEMPERATURE                  = 0xff000007,
    ...
    EIZO_USAGE_SELF_DIAGNOSIS               = 0xff00004e,
    EIZO_USAGE_SELF_COMPENSATION_TARGET     = 0xff00004f,
    EIZO_USAGE_GAMMA                        = 0xff000066,
    EIZO_USAGE_SELF_COMPENSATION_BRIGHTNESS = 0xff000077,
    EIZO_USAGE_SELF_COMPENSATION_COLOR      = 0xff000078,
    ...
    EIZO_USAGE_MODEL_SPACE                  = 0xff0000c3,
    ...
    EIZO_USAGE_SIGNAL_TYPE                  = 0xff01003b,
    ...
    EIZO_USAGE_AVAILABLE_CUSTOM_KEY_LOCK_1  = 0xff010058,
    EIZO_USAGE_AVAILABLE_CUSTOM_KEY_LOCK_2  = 0xff010059,
    EIZO_USAGE_CUSTOM_KEY_LOCK              = 0xff01005a,
    ...
    EIZO_USAGE_ACTIVE_WINDOW                = 0xff0100f9,
    EIZO_USAGE_PICTURE_BY_PICTURE_LAYOUT    = 0xff0100fa,
    ...
    EIZO_USAGE_BACKLIGHT_REPLACE_INFO       = 0xff02002e,
    EIZO_USAGE_SERIAL_NULL                  = 0xff020036,
...
enum eizo_temperature : uint16_t {
    EIZO_TEMPERATURE_OFF    = 0,
    EIZO_TEMPERATURE_4000K  = 1,
    EIZO_TEMPERATURE_4500K  = 2,
    EIZO_TEMPERATURE_5000K  = 3,
    EIZO_TEMPERATURE_5500K  = 4,
    EIZO_TEMPERATURE_6000K  = 5,
    EIZO_TEMPERATURE_6500K  = 6,
    EIZO_TEMPERATURE_7000K  = 7,
    EIZO_TEMPERATURE_7500K  = 8,
    EIZO_TEMPERATURE_8000K  = 9,
    EIZO_TEMPERATURE_8500K  = 10,
    EIZO_TEMPERATURE_9000K  = 11,
    EIZO_TEMPERATURE_9300K  = 12,
    EIZO_TEMPERATURE_9500K  = 13,
    EIZO_TEMPERATURE_10000K = 14,
};
...
enum eizo_profile : uint16_t {
    EIZO_PROFILE_TEXT             = 0x0000,
    EIZO_PROFILE_PICTURE          = 0x0001,
    EIZO_PROFILE_MOVIE            = 0x0002,
    EIZO_PROFILE_CUSTOM           = 0x0003,
    EIZO_PROFILE_SRGB             = 0x0004,
    EIZO_PROFILE_EXT              = 0x0005,
    EIZO_PROFILE_VIEWER           = 0x0006,
    EIZO_PROFILE_CAL              = 0x0007,
    EIZO_PROFILE_DICOM_CB         = 0x0008,
    EIZO_PROFILE_DICOM_BB         = 0x0009,
    EIZO_PROFILE_EMU              = 0x000a,
    EIZO_PROFILE_CAL1             = 0x000b,
    EIZO_PROFILE_CAL2             = 0x000c,
    EIZO_PROFILE_CAL3             = 0x000d,
    EIZO_PROFILE_CAD              = 0x000e,
    EIZO_PROFILE_CIE              = 0x000f,
    EIZO_PROFILE_FL               = 0x0010,
    EIZO_PROFILE_GAME             = 0x0011,
    EIZO_PROFILE_REC709           = 0x0012,
    EIZO_PROFILE_EBU              = 0x0013,
    EIZO_PROFILE_SMPTE_C          = 0x0014,
    EIZO_PROFILE_DCI              = 0x0015,
    EIZO_PROFILE_USER1            = 0x0016,
    EIZO_PROFILE_USER2            = 0x0017,
    EIZO_PROFILE_USER3            = 0x0018,
    EIZO_PROFILE_RESERVED1        = 0x0019,
    EIZO_PROFILE_RESERVED2        = 0x001a,
    EIZO_PROFILE_RESERVED3        = 0x001b,
    EIZO_PROFILE_CG_CAL1          = 0x001c,
    EIZO_PROFILE_CG_CAL2          = 0x001d,
    EIZO_PROFILE_CG_CAL3          = 0x001e,
    EIZO_PROFILE_EYE_CARE         = 0x001f,
    EIZO_PROFILE_ADOBE_RGB        = 0x0020,
    EIZO_PROFILE_CINEMA           = 0x0021,
    EIZO_PROFILE_PAPER            = 0x0022,
    EIZO_PROFILE_HYBRID_GAMMA     = 0x0023,
    EIZO_PROFILE_ECO              = 0x0024,
    EIZO_PROFILE_ALT              = 0x0025,
    EIZO_PROFILE_DAY              = 0x0026,
    EIZO_PROFILE_NIGHT            = 0x0027,
    EIZO_PROFILE_FPS1             = 0x0028,
    EIZO_PROFILE_FPS2             = 0x0029,
    EIZO_PROFILE_RTS              = 0x002a,
    EIZO_PROFILE_WEB              = 0x002b,
    EIZO_PROFILE_GAME_DARK_SCENE  = 0x002c,
    EIZO_PROFILE_GAME_LIGHT_SCENE = 0x002d,

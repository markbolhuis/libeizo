...
enum eizo_eep_address : uint16_t {
    EIZO_EEP_ADDRESS_PRODUCT_STRING_1   = 0x001e,
    EIZO_EEP_ADDRESS_SERIAL_STRING      = 0x0026,
    EIZO_EEP_ADDRESS_PRODUCT_STRING_2   = 0x002e,
    ...
    EIZO_EEP_ADDRESS_PROFILE            = 0x00d1,
    EIZO_EEP_ADDRESS_BRIGHTNESS         = 0x00d3,
    EIZO_EEP_ADDRESS_CONTRAST           = 0x00d4,
    EIZO_EEP_ADDRESS_COLOR_TEMPERATURE  = 0x00d5,
    EIZO_EEP_ADDRESS_GAMMA              = 0x00d6,
    EIZO_EEP_ADDRESS_SATURATION         = 0x00d7,
    EIZO_EEP_ADDRESS_HUE                = 0x00d8,
    EIZO_EEP_ADDRESS_GAIN_RED           = 0x00da,
    EIZO_EEP_ADDRESS_GAIN_GREEN         = 0x00db,
    EIZO_EEP_ADDRESS_GAIN_BLUE          = 0x00dc,
    EIZO_EEP_ADDRESS_SUPER_RESOLUTION   = 0x00dd,
    EIZO_EEP_ADDRESS_POWER_SAVE         = 0x0115,
    EIZO_EEP_ADDRESS_PICTURE_EXPANSION  = 0x011a,
    EIZO_EEP_ADDRESS_POWER_INDICATOR    = 0x011b,
